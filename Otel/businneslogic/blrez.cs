...
namespace Otel.businneslogic
{
    internal class blrez
    {
        ...
        internal void rezkaydet(  string musteriAd,string musteriSoyad,long musteriTc,string odaNo,string giris,string cikis,string odaTipi,string fiyat)
        {

            (new dalrez()).rezkaydet(new elrez( musteriAd,musteriSoyad,musteriTc,odaNo,giris,cikis,odaTipi,fiyat));
        }
      ...
      private dalrez _dalrez= new dalrez();
        ...
        {
            return _dalrez.rezguncelle(/*musteriId,*/ musteriad, musterisoyad,musteriTc,odaNo, giris, cikis,odaTipi,fiyat);
        }
